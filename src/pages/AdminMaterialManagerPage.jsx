...
export default function AdminMaterialManagerPage() {
  ...
  async function handleDelete(materialId) {
    ...
    try {
      await deleteAdminMaterial(auth.token, materialId)
        ...
        <section className="admin-section">
          <div className="admin-section-head">
            <div>
              ...
              <p className="admin-copy">
                {editingId
                  ? 'Ubah metadata materi, lalu simpan. Upload file baru bersifat opsional saat edit.'
                  : 'Buat materi baru untuk kategori ini. Upload file diwajibkan saat create.'}
              </p>
            </div>
          </div>
          ...
          <form className="admin-form admin-form--materials" onSubmit={handleSubmit}>
            ...
            <div className="admin-actions admin-actions--split">
              <div className="admin-copy">
                {editingId ? 'Mode edit aktif.' : 'Mode tambah aktif.'}
              </div>
                      ...
                      <tr key={material.id}>
                        ...
                        <td>
                          <div className="material-actions">
                            ...
                            <button type="button" className="ghost-btn" onClick={() => handleDelete(material.id)}>
                              Delete
                            </button>
                          </div>
                        </td>
